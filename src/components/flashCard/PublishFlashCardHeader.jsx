...
export default function PublishFlashCardHeader({handleCreateFlashCard, setShowInFlashCard}) {
  return (
    <div className=" w-full mx-auto md:max-w-[80%] flex justify-between items-center p-4 rounded-lg">
      ...
      <div className="flex  items-center md:gap-4 gap-2">
        ...
        <Button className="bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-lg  md:text-base text-xs" onClick={handleCreateFlashCard}>
          <Upload/> Create
        </Button>
      </div>
    </div>
