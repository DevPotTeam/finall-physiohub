...
export default function PublishCourseHeader({handleCoursePublish}) {
  return (
    <div className="  w-full mx-auto max-w-[80%] flex justify-between items-center p-4 rounded-lg">
      ...
      <div className="flex items-center gap-4">
        ...
        <Button className="bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-lg" onClick={handleCoursePublish}>
          <Upload/> Publish
        </Button>
      </div>
    </div>
